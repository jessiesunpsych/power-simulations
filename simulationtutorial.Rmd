...
Here are the parameter estimates. The parameter of interest, y  ~  x1, is in row 4. As you can see, this parameter was statistically significant (*p* = .028) in this simulation based on one dataset.
